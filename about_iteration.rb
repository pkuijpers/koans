...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # It passes the result of the resulting evaluation (or the given default
    # value for the first iteration) and the item to a block. The result of the
    # block is the value for the next iteration.
  end
